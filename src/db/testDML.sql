...
-- select distinct * from mamami_item a join mamami_item_part b on a.mamami_item_id=b.mamami_item_id order by b.mamami_item_part_id asc;
-- select * from mamami_item_part;
